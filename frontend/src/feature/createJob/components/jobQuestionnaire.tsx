        ...
        <>
            ...
            <div style={{ boxSizing: 'border-box', position: 'absolute', width: '756px', height: '80px', left: '548px', top: '246px', background: '#FFFFFF', border: '1px solid #CBCBCB', borderRadius: '10px' }}>
                <input style={{ position: 'absolute', width: '300px', height: '40px', left: '10px', top: '2px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: 'black' }}
                    onChange={(e) => { setQues1(e.target.value); }} value={question1} placeholder="Question 1" />
            </div>

            <div style={{ boxSizing: 'border-box', position: 'absolute', width: '756px', height: '80px', left: '548px', top: '342px', background: '#FFFFFF', border: '1px solid #CBCBCB', borderRadius: '10px' }}>
                <input style={{ position: 'absolute', width: '300px', height: '40px', left: '10px', top: '2px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: 'black' }}
                    onChange={(e) => { setQues2(e.target.value); }} value={question2} placeholder="Question 2" />
            </div>

            <div style={{ boxSizing: 'border-box', position: 'absolute', width: '756px', height: '80px', left: '548px', top: '438px', background: '#FFFFFF', border: '1px solid #CBCBCB', borderRadius: '10px' }}>
                <input style={{ position: 'absolute', width: '300px', height: '40px', left: '10px', top: '2px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: 'black' }}
                    onChange={(e) => { setQues3(e.target.value); }} value={question3} placeholder="Question 3" />
            </div>

            <div style={{ boxSizing: 'border-box', position: 'absolute', width: '756px', height: '80px', left: '548px', top: '534px', background: '#FFFFFF', border: '1px solid #CBCBCB', borderRadius: '10px' }}>
                <input style={{ position: 'absolute', width: '300px', height: '40px', left: '10px', top: '2px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: 'black' }}
