...
export const CreateJob = () => {
  ...
  return (
    ...
    <>
      ...
      <div style={{ position: 'absolute', width: '109px', height: '19px', left: '80px', top: '272px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: '#CBCBCB', whiteSpace: 'nowrap' }}>
        Fill Questionnaire
      </div>
      ...
      <div style={{ position: 'absolute', width: '109px', height: '19px', left: '80px', top: '312px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: '#CBCBCB', whiteSpace: 'nowrap' }}>
        Preview
      </div>
      ...
      <div style={{ position: 'absolute', width: '138px', height: '36px', left: '548px', top: '154px', fontFamily: 'Poppins', fontStyle: 'normal', fontWeight: 500, fontSize: '24px', lineHeight: '36px', color: '#000000' }}>
        Add Details
      </div>

      <div style={{ boxSizing: 'border-box', position: 'absolute', width: '344px', height: '50px', left: '548px', top: '220px', background: '#FFFFFF', border: '1px solid #CBCBCB', borderRadius: '10px' }}>
        <input style={{ position: 'absolute', width: '300px', height: '40px', left: '10px', top: '2px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: 'black' }} onChange={(e) => { setName(e.target.value); }} value={name} placeholder="Job Role" />
      </div>
      ...
      <div style={{ boxSizing: 'border-box', position: 'absolute', width: '344px', height: '50px', left: '548px', top: '357px', background: '#FFFFFF', border: '1px solid #CBCBCB', borderRadius: '10px' }}>
      ...
      <div style={{ boxSizing: 'border-box', position: 'absolute', width: '344px', height: '50px', left: '548px', top: '425px', background: '#FFFFFF', border: '1px solid #CBCBCB', borderRadius: '10px' }}>
        <input style={{ position: 'absolute', width: '300px', height: '40px', left: '10px', top: '2px', fontFamily: 'Urbanist', fontStyle: 'normal', fontWeight: 400, fontSize: '16px', lineHeight: '19px', color: 'black' }}
